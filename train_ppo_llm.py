...
parser.add_argument('--epochs', type=int, default=25) # 10 for test otherwise 100 it is too much 150)  # Updated to match epochs in ppo
...
# Save the model
model_path = TRAINED_MODEL_DIR + "/agent_ppo_qwen_25_epochs_20k_steps.pth"
